...
<template>
    ...
    <div class="createActivity-container">
      ...
      <div class='theme-view'>
        <textarea class='theme'   maxlength='30'  value="" v-model="textareaContent"/>
      </div>
      <!-- 关键字 -->
      <input class='keyword' placeholder='请输入关键字' value="课外读本" maxlength='4' >
      <!-- 活动类型选择器 -->
      <div class="type-container" @click="popupVisible = true" >
        <div class="type-active">合作基地
      ...
      <div class='date-container'>
        ...
        <mt-button @click="open('picker1')" size="large">
          <div class='start-time' >2018-08-25 8:00
        ...
        <!-- 结束时间 -->
        <mt-button @click="open('picker1')" size="large">
          <div class='end-time' >2018-10-25 8:00
            <img class='calendar-img' src='../../../assets/icon_calendar.png' />
          </div>
      ...
      <div class='remarks-container'>
        <textarea class='remarks' maxlength='3000' placeholder='请输入活动内容，最多3000字' placeholder-style='color:#b7bdc6'   value="" >我们在班级门口设立了一个资源收集架子，注明标志，请家长、幼儿一起参与资源收集。我们还告知家长具体的收集内容，如祖国各地风景名胜的图片、纪念品，四大发明的图片或模型、京剧脸谱、民族服装的图片与实物等。在家长的协助下，我们收集了丰富的资源。面对琳琅满目的资源，我们开始思考如何通过规范分类完善该主题资料库的体系。
        </textarea>
...
<script>
  ...
  data () {
    return {
      ...
      slots:[{values: ['合作基地', '合作机构', '设施', '物料', '其他']}],
      currentTags: {},
      // 拍照
      actions:[],
      sheetVisible:false,
